  ...
  render: () => (
    <div className="flex gap-8">
      <div className="flex flex-col items-center gap-2">
        <SettingsIcon size="md" className="text-gray-600" />
        <span className="text-xs text-gray-500">Gray</span>
      </div>
      <div className="flex flex-col items-center gap-2">
        <SettingsIcon size="md" className="text-blue-600" />
        <span className="text-xs text-gray-500">Blue</span>
      </div>
      <div className="flex flex-col items-center gap-2">
        <SettingsIcon size="md" className="text-purple-600" />
        <span className="text-xs text-gray-500">Purple</span>
      </div>
      <div className="flex flex-col items-center gap-2">
        <SettingsIcon size="md" className="text-green-600" />
  ...
  render: () => (
    <div className="flex gap-4">
      <div className="p-3 bg-gray-100 rounded-lg hover:bg-gray-200 cursor-pointer">
        <SettingsIcon size="md" className="text-gray-700" />
      </div>
      <div className="p-3 bg-blue-100 rounded-lg hover:bg-blue-200 cursor-pointer">
        <SettingsIcon size="md" className="text-blue-700" />
      </div>
      <div className="p-3 bg-purple-100 rounded-lg hover:bg-purple-200 cursor-pointer">
        <SettingsIcon size="md" className="text-purple-700" />
      </div>
    </div>
  ),
};
