...
export const GalleryPhotoIcon: React.FC<GalleryPhotoIconProps> = ({
  size = "md",
  color = "currentColor",
  className = "",
  ...props
  ...
  return (
    <svg
      ...
      className={`icon icon-tabler icons-tabler-outline icon-tabler-library-photo ${className}`.trim()}
      {...props}
    >
...
GalleryPhotoIcon.displayName = "GalleryPhotoIcon";
