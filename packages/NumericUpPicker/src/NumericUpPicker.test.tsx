...
describe('NumericUpPicker Component', () => {
  describe('Basic Rendering', () => {
    ...
    it('should display required asterisk when required is true', () => {
      render(<NumericUpPicker label="Amount" value="0" onChange={jest.fn()} required={true} />);
      const label = screen.getByText('Amount');
      expect(label.parentElement).toHaveTextContent('*');
    });

    it('should not display required asterisk when required is false', () => {
      render(<NumericUpPicker label="Amount" value="0" onChange={jest.fn()} required={false} />);
      const label = screen.getByText('Amount');
  ...
  describe('Increment/Decrement Buttons', () => {
    ...
    it('should not decrement below min value', async () => {
      const handleChange = jest.fn();
      render(<NumericUpPicker value="0" onChange={handleChange} min={0} step={1} />);
    ...
    it('should not increment above max value', async () => {
      const handleChange = jest.fn();
      render(<NumericUpPicker value="10" onChange={handleChange} max={10} step={1} />);
  ...
  describe('Keyboard Arrow Controls', () => {
    ...
    it('should work with integer only mode using ArrowUp', () => {
      const handleChange = jest.fn();
      render(<NumericUpPicker value="5" onChange={handleChange} step={1} integerOnly={true} />);
  ...
  describe('Min/Max Constraints', () => {
    ...
    it('should enforce min constraint during increment', () => {
      const handleChange = jest.fn();
      render(<NumericUpPicker value="9" onChange={handleChange} min={5} max={10} step={1} />);
    ...
    it('should enforce max constraint during decrement', () => {
      const handleChange = jest.fn();
      render(<NumericUpPicker value="6" onChange={handleChange} min={5} max={10} step={1} />);
  ...
  describe('Direct Input', () => {
    ...
    it('should call onBlur when input loses focus', async () => {
      ...
      render(<NumericUpPicker value="0" onChange={jest.fn()} onBlur={handleBlur} />);
    ...
    it('should call onFocus when input receives focus', async () => {
      ...
      render(<NumericUpPicker value="0" onChange={jest.fn()} onFocus={handleFocus} />);
  ...
  describe('Disabled State', () => {
    it('should disable all buttons when disabled prop is true', () => {
      render(<NumericUpPicker value="0" onChange={jest.fn()} disabled={true} />);
    ...
    it('should not accept input when disabled', async () => {
      const handleChange = jest.fn();
      render(<NumericUpPicker value="0" onChange={handleChange} disabled={true} />);
  ...
  describe('Error/Warning/Hint Messages', () => {
    it('should display error message when error prop is provided', () => {
      render(<NumericUpPicker value="0" onChange={jest.fn()} error="Value must be positive" />);
    ...
    it('should display warning message when warning prop is provided', () => {
      render(<NumericUpPicker value="0" onChange={jest.fn()} warning="This is a warning" />);
    ...
    it('should display hint message when hint prop is provided', () => {
      render(<NumericUpPicker value="0" onChange={jest.fn()} hint="Enter a value" />);

      expect(screen.getByText('Enter a value')).toBeInTheDocument();
    });

    it('should not display hint when error is present', () => {
      render(<NumericUpPicker value="0" onChange={jest.fn()} error="Error" hint="Helpful hint" />);
    ...
    it('should not display hint when warning is present', () => {
      render(
        <NumericUpPicker value="0" onChange={jest.fn()} warning="Warning" hint="Helpful hint" />
      );
    ...
    it('should show error icon when error exists', () => {
      const { container } = render(
        <NumericUpPicker value="0" onChange={jest.fn()} error="Error message" />
      );
  ...
  describe('Placeholder', () => {
    it('should display placeholder text', () => {
      render(<NumericUpPicker value="" onChange={jest.fn()} placeholder="Enter amount" />);
    ...
    it('should show placeholder when value is empty', () => {
      render(<NumericUpPicker value="" onChange={jest.fn()} placeholder="Enter value" />);
  ...
  describe('Step Value', () => {
    it('should use custom step value', () => {
      const { container } = render(<NumericUpPicker value="0" onChange={jest.fn()} step={5} />);
    ...
    it('should default to 0.01 step when not provided', () => {
      const { container } = render(<NumericUpPicker value="0" onChange={jest.fn()} />);
  ...
  describe('CSS Classes', () => {
    it('should accept custom className', () => {
      const { container } = render(
        <NumericUpPicker value="0" onChange={jest.fn()} className="custom-class" />
      );
  ...
  describe('Complex Interactions', () => {
    ...
    it('should handle rapid increment/decrement', async () => {
      const handleChange = jest.fn();
      render(<NumericUpPicker value="5" onChange={handleChange} min={0} max={10} step={1} />);
    ...
    it('should format output correctly', () => {
      const handleChange = jest.fn();
      render(<NumericUpPicker value="10" onChange={handleChange} step={0.01} />);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very small decimal numbers', () => {
      render(<NumericUpPicker value="0.001" onChange={jest.fn()} step={0.001} />);
  ...
  describe('useMinAsDefault Prop', () => {
    it('should allow displaying value less than min but adjust to min on blur when useMinAsDefault is true', () => {
      const handleChange = jest.fn();
      render(<NumericUpPicker value="0" onChange={handleChange} min={50} useMinAsDefault={true} />);
    ...
    it('should display value as-is when value is greater than min', () => {
      render(<NumericUpPicker value="75" onChange={jest.fn()} min={50} useMinAsDefault={true} />);
    ...
    it('should display value as-is when useMinAsDefault is false', () => {
      render(<NumericUpPicker value="0" onChange={jest.fn()} min={50} useMinAsDefault={false} />);
    ...
    it('should ignore useMinAsDefault when min is not provided', () => {
      render(<NumericUpPicker value="0" onChange={jest.fn()} useMinAsDefault={true} />);
    ...
    it('should handle decimal min values correctly', () => {
      const handleChange = jest.fn();
      render(
        <NumericUpPicker value="1.5" onChange={handleChange} min={50.5} useMinAsDefault={true} />
      );
    ...
    it('should work with negative min values', () => {
      const handleChange = jest.fn();
      render(
        <NumericUpPicker value="-100" onChange={handleChange} min={-50} useMinAsDefault={true} />
      );
    ...
    it('should update displayed value when value prop changes', () => {
      const { rerender } = render(
        <NumericUpPicker value="0" onChange={jest.fn()} min={50} useMinAsDefault={true} />
      );

      let input = screen.getByRole('textbox');
      expect(input).toHaveValue('0');

      rerender(<NumericUpPicker value="75" onChange={jest.fn()} min={50} useMinAsDefault={true} />);
  ...
  describe('Two Decimal Places Formatting', () => {
    it('should format integer values with two decimal places on blur', async () => {
      const handleChange = jest.fn();
      const { rerender } = render(<NumericUpPicker value="" onChange={handleChange} />);
    ...
    it('should format empty value to 0.00 on blur when required', async () => {
      const handleChange = jest.fn();
      render(<NumericUpPicker value="" onChange={handleChange} required={true} />);
    ...
    it('should format negative values with two decimal places', async () => {
      const handleChange = jest.fn();
      const { rerender } = render(<NumericUpPicker value="" onChange={handleChange} min={-10} />);

      const input = screen.getByRole('textbox');

      await userEvent.type(input, '-5');

      rerender(<NumericUpPicker value="-5" onChange={handleChange} min={-10} />);
    ...
    it('should format value at max constraint with two decimal places', () => {
      const handleChange = jest.fn();
      render(<NumericUpPicker value="9.00" onChange={handleChange} max={10} step={1} />);
    ...
    it('should format value at min constraint with two decimal places', () => {
      const handleChange = jest.fn();
      render(<NumericUpPicker value="0.5" onChange={handleChange} min={0} step={0.25} />);
  ...
  describe('Empty Value Increment/Decrement Behavior', () => {
    it('should start from min value when incrementing from empty (positive range)', () => {
      const handleChange = jest.fn();
      render(<NumericUpPicker value="" onChange={handleChange} min={15} max={25} step={1} />);
    ...
    it('should start from min value when incrementing from empty (negative range)', () => {
      const handleChange = jest.fn();
      render(<NumericUpPicker value="" onChange={handleChange} min={-15} max={-1} step={1} />);
    ...
    it('should default to 0 when incrementing from empty with no min', () => {
      const handleChange = jest.fn();
      render(<NumericUpPicker value="" onChange={handleChange} max={100} step={1} />);
    ...
    it('should default to 0 when decrementing from empty with no max', () => {
      const handleChange = jest.fn();
      render(<NumericUpPicker value="" onChange={handleChange} min={-100} step={1} />);
