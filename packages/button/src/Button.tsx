...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantColors = {
      ...
      'gradient-green': {
        outlined: 'text-emerald-400 border-2 border-emerald-400 hover:bg-emerald-50',
        filled: 'bg-gradient-to-r from-emerald-400 to-cyan-400 text-white hover:opacity-90',
      },
      'solid-green': {
        outlined: 'text-emerald-500 border-2 border-emerald-500 hover:bg-emerald-50',
      ...
      warning: {
        outlined: 'text-orange-500 border-2 border-orange-500 hover:bg-orange-50',
    ...
    if (disabled) {
      ...
      colorClasses = isFilledStyle ? variantStyle.filled : variantStyle.outlined;
    }
    ...
    const focusClasses = disabled
      ? ''
      : {
          filled: 'focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-current',
          outline: 'focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-current',
