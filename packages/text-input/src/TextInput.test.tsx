...
describe('TextInput Component', () => {
  describe('Basic Rendering', () => {
    ...
    it('should display required asterisk when required is true', () => {
      render(<TextInput label="Email" value="" onChange={() => {}} required={true} />);
    ...
    it('should not display required asterisk when required is false', () => {
      render(<TextInput label="Email" value="" onChange={() => {}} required={false} />);
    ...
    it('should display hint text when provided', () => {
      render(<TextInput hint="This is a helpful hint" value="" onChange={() => {}} />);
      expect(screen.getByText('This is a helpful hint')).toBeInTheDocument();
    });

    it('should not display hint when error is present', () => {
      render(<TextInput hint="Helpful hint" error="Error message" value="" onChange={() => {}} />);
  ...
  describe('Error Handling', () => {
    ...
    it('should display error icon when error is present', () => {
      ...
      const errorIcon = screen.getByText('Error message').parentElement?.querySelector('svg');
  ...
  describe('Constraints', () => {
    ...
    it('should show character count when maxLength is set', () => {
      render(<TextInput value="Hello" onChange={() => {}} maxLength={10} type="text" />);
      expect(screen.getByText('5/10')).toBeInTheDocument();
    });

    it('should highlight character count when near limit (80%)', () => {
      render(<TextInput value="12345678" onChange={() => {}} maxLength={10} type="text" />);
    ...
    it('should show red character count when at limit (100%)', () => {
      render(<TextInput value="1234567890" onChange={() => {}} maxLength={10} type="text" />);
  ...
  describe('Email Validation', () => {
    it('should validate email format when validateEmail is true', () => {
      render(
        <TextInput value="valid@email.com" onChange={() => {}} type="email" validateEmail={true} />
      );
    ...
    it('should show invalid email message for incorrect format', () => {
      render(
        <TextInput value="invalid-email" onChange={() => {}} type="email" validateEmail={true} />
      );
    ...
    it('should not validate email when validateEmail is false', () => {
      render(<TextInput value="invalid" onChange={() => {}} type="email" validateEmail={false} />);
      expect(screen.queryByText('Correo inválido')).not.toBeInTheDocument();
    });

    it('should not show validation when value is empty', () => {
      render(<TextInput value="" onChange={() => {}} type="email" validateEmail={true} />);
  ...
  describe('Password Strength', () => {
    ...
    it('should show weak password strength', () => {
      render(
        <TextInput value="aaa" onChange={() => {}} type="password" showPasswordStrength={true} />
      );
  ...
  describe('Icon Support', () => {
    ...
    it('should hide icon when input is focused', async () => {
      render(
        <TextInput value="" onChange={() => {}} icon={<span data-testid="test-icon">Icon</span>} />
      );
  ...
  describe('Integration Tests', () => {
    ...
    it('should combine error styling with maxLength styling', () => {
      render(<TextInput value="1234567890" onChange={() => {}} maxLength={10} error="Error" />);
      const input = screen.getByRole('textbox') as HTMLInputElement;
  ...
  describe('Email Validation', () => {
    it('should validate email format correctly', () => {
      const { rerender } = render(<TextInput value="" onChange={() => {}} validateEmail />);

      // Empty should not show error
      expect(screen.queryByText(/Correo electrónico inválido/)).not.toBeInTheDocument();

      // Invalid email
      rerender(<TextInput value="invalid-email" onChange={() => {}} validateEmail />);
      expect(screen.getByText('Correo electrónico inválido')).toBeInTheDocument();

      // Valid email
      rerender(<TextInput value="test@example.com" onChange={() => {}} validateEmail />);
      expect(screen.getByText('Correo válido')).toBeInTheDocument();
      expect(screen.queryByText(/Correo electrónico inválido/)).not.toBeInTheDocument();
    });
    ...
    it('should accept various valid email formats', () => {
      ...
      validEmails.forEach((email) => {
        const { unmount } = render(<TextInput value={email} onChange={() => {}} validateEmail />);
    ...
    it('should suggest correction for common typos', () => {
      render(<TextInput value="test@gmial.com" onChange={() => {}} validateEmail />);
    ...
    it('should suggest correction for hotmail typo', () => {
      render(<TextInput value="user@hotmial.com" onChange={() => {}} validateEmail />);
    ...
    it('should apply suggestion when clicked', async () => {
      ...
      render(<TextInput value="test@gmial.com" onChange={handleChange} validateEmail />);
    ...
    it('should not show suggestion for valid emails', () => {
      render(<TextInput value="test@gmail.com" onChange={() => {}} validateEmail />);

      expect(screen.queryByText(/¿Quisiste decir/)).not.toBeInTheDocument();
    });

    it('should not show suggestion when no typo detected', () => {
      render(<TextInput value="test@unknowndomain.com" onChange={() => {}} validateEmail />);
